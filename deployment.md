...
```java
git clone https://github.com/kyopark2014/puppy-counseling
```

5) cdk 폴더로 이동하여 필요한 라이브러리를 설치합니다.

```java
cd puppy-counseling/cdk-puppy-counseling/ && npm install
```
...
![image](https://github.com/kyopark2014/puppy-counseling/assets/52392004/766b4d33-13c9-49b1-9462-832120f73109)

8) HTMl 파일을 S3에 복사합니다.

아래와 같이 Output의 HtmlUpdateCommend을 붙여넣기 합니다. 

![image](https://github.com/kyopark2014/puppy-counseling/assets/52392004/130bae3d-3bde-43a8-8bcb-55cee1e06e42)
